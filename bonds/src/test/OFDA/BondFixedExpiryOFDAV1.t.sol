...
import {BondFixedExpiryOFDA} from "../../BondFixedExpiryOFDA.sol";
...
// V1 test suite doesn't use a callback
contract BondFixedExpiryOFDAV1Test is Test {
    ...
    BondFixedExpiryOFDA internal auctioneer;
    ...
    function setUp() public {
        ...
        auctioneer = new BondFixedExpiryOFDA(teller, aggregator, guardian, auth);
        ...
        )
    {
        ...
        uint48 vesting = uint48(block.timestamp + 14 days); // fixed expiry 14 days from start
    ...
    function testCorrectness_isLive(uint48 conclusion_) public {
        ...
        params.vesting = conclusion_ + 1 days;
