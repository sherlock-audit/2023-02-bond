...
// V3 test suite is for instant swap markets using a callback
contract BondFixedTermOSDAV3Test is Test {
    ...
    /* ========== OSDA TESTS ========== */
    // [X] Market creation - instant swap
    ...
    // [X] Market behavior - instant swap
