...
interface IBondOSDA is IBondAuctioneer {
    ...
    struct BondTerms {
        ...
        uint48 length; // time from creation to conclusion.
    ...
    /// @dev                    9. Deposit interval (seconds). Desired frequency of bonds. Used to calculate max payout of market (maxPayout = length / depositInterval * capacity)
